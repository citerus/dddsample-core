...
public class ItineraryCandidateDTOAssemblerTest {
  ...
  public void testToDTO() {
    ...
    final Itinerary itinerary = new Itinerary(
      Arrays.asList(
        new Leg(CM001.voyageNumber(), origin, SHANGHAI, new Date(), new Date()),
        new Leg(CM001.voyageNumber(), ROTTERDAM, destination, new Date(), new Date())
      )
    );
  ...
  public void testFromDTO() {
    ...
    // Tested call
    final Itinerary itinerary = assembler.fromDTO(new RouteCandidateDTO(legs), locationRepository);
